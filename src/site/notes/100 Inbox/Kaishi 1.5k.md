...
do which / sure 
## ru (adds to )
a to have/exist (inanimate)
i to have (animate (like the brother one))
	兄が**います**。
tsu to do / make
ta to come (to do )/to become/to result in
o-shi-e to tell / teachccm
## __ no 
so there
...
ki ku to heal
## __ u
ko this way/this kid of 
so that way/ in such maneer
do  how what
会う (a u) to bmeet